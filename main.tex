...
\subsection*{Written Statement: Individual Contribution and Group Collaboration}
All group members must contribute to the project and understand the final report content. Each member should be able to explain all the choices and justification made throughout the project. Each member should understand how the model was implemented and how the results were obtained. If there are any concerns about individual contributions, please contact the instructor as soon as possible. 

The final report should contain an annex with a statement with individual contributions and roles, signed by all group members.
...
\input{chapters/01_model_definition.tex}
\input{chapters/02_numerical_methods.tex}
\input{chapters/03_numerical_schemes.tex}
\input{chapters/04_results_analysis.tex}
