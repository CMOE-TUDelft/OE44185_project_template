% White Paper style for OE44185 project reports
...
\AtEndDocument{%
    ...
    \ifnum\value{appendixstartpage}>0
        \ifnum\numexpr\value{appendixstartpage}-1\relax>\value{maxreportpages}
            \typeout{==============================================}%
            \typeout{OE44185 PAGE LIMIT WARNING: main report exceeds 15 pages.}%
    ...
    \else
        \ifnum\value{page}>\value{maxreportpages}
            \typeout{==============================================}%
            \typeout{OE44185 PAGE LIMIT WARNING: document exceeds 15 pages.}%
            \typeout{Reduce content in the main report and move detail to appendices.}%
            \typeout{==============================================}%
